...
xsApplyAutoRegressionFromFile: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsApplyAutoRegressionFromFile.o  $(OBJDIR)/saContext.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saConcept.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(LDFLAGS)
xsApplyLinearRegression: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsApplyLinearRegression.o $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saContext.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saConcept.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(LDFLAGS)
xsApplyLinearRegressionFromFile: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsApplyLinearRegressionFromFile.o  $(OBJDIR)/saContext.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saConcept.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(LDFLAGS)
xsApplyQuadRegression: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsApplyQuadRegression.o  $(OBJDIR)/saContext.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saConcept.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(LDFLAGS)
xsApplyQuadRegressionFromFile: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsApplyQuadRegressionFromFile.o  $(OBJDIR)/saContext.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saConcept.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(LDFLAGS)
xsCloneContext: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsCloneContext.o $(OBJDIR)/saContext.o $(OBJDIR)/saConcept.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o  $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(LDFLAGS)
xsCloneConcept: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsCloneConcept.o $(OBJDIR)/saContext.o $(OBJDIR)/saConcept.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o  $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(LDFLAGS)
xsCreateContext: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsCreateContext.o $(OBJDIR)/saContext.o $(OBJDIR)/saConcept.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o  $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(LDFLAGS)
xsCreateConcept: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsCreateConcept.o $(OBJDIR)/saContext.o $(OBJDIR)/saConcept.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o  $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(LDFLAGS)
xsDeleteContext: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsDeleteContext.o $(OBJDIR)/saContext.o $(OBJDIR)/saConcept.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o  $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(LDFLAGS)
...
xsDisplayConcept: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsDisplayConcept.o $(OBJDIR)/saContext.o  $(OBJDIR)/saConcept.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o  $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(WINOBJS) $(LDFLAGS)
xsDisplayWhere: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsDisplayWhere.o $(OBJDIR)/saContext.o  $(OBJDIR)/saConcept.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o $(OBJDIR)/saParser.o $(OBJDIR)/saHash.o  $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(OBJDIR)/saTokenize.tab.o $(OBJDIR)/lex.yy.o $(LICENSELIB) $(LDFLAGS)
xsFindBestConcept: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsFindBestConcept.o $(OBJDIR)/saContext.o  $(OBJDIR)/saConcept.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o $(OBJDIR)/saHash.o  $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(LDFLAGS)
xsFindMembership: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsFindMembership.o $(OBJDIR)/saContext.o  $(OBJDIR)/saConcept.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o  $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(LDFLAGS)
xsGetCompatibility: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsGetCompatibility.o $(OBJDIR)/saContext.o  $(OBJDIR)/saConcept.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o $(OBJDIR)/saAutoRegression.o  $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB)  $(LDFLAGS)
xsGetDistance: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsGetDistance.o $(OBJDIR)/saGeoLiteCity.o $(OBJDIR)/saStatistics.o $(OBJDIR)/saContext.o $(OBJDIR)/saConcept.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o $(OBJDIR)/saHash.o $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(WINOBJS) $(LDFLAGS)
xsGetWhereCix: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsWhere.o $(OBJDIR)/saParser.o $(OBJDIR)/saHash.o $(OBJDIR)/saContext.o  $(OBJDIR)/saConcept.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o  $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(OBJDIR)/saTokenize.tab.o $(OBJDIR)/lex.yy.o $(LICENSELIB) $(LDFLAGS)
xsListContexts: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsListContexts.o $(OBJDIR)/saContext.o  $(OBJDIR)/saConcept.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o $(OBJDIR)/saListDir.o  $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(LDFLAGS)
xsListConcepts: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsListConcepts.o $(OBJDIR)/saContext.o  $(OBJDIR)/saConcept.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o  $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(WINOBJS) $(LDFLAGS)
xsListUOM: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsListUOM.o $(OBJDIR)/saContext.o  $(OBJDIR)/saConcept.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o  $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(WINOBJS) $(LDFLAGS)
...
xsWhere: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsWhere.o $(OBJDIR)/saParser.o  $(OBJDIR)/saConcept.o $(OBJDIR)/saContextCreate.o $(OBJDIR)/saContext.o  $(OBJDIR)/saHash.o $(OBJDIR)/saSplunk.o $(OBJDIR)/saHedge.o $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o   $(OBJDIR)/saTokenize.tab.o $(OBJDIR)/lex.yy.o $(LICENSELIB) $(LDFLAGS)
xspreautoregress: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xspreautoregress.o $(OBJDIR)/saAutoRegression.o $(OBJDIR)/saInsertUniqueValue.o $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(LDFLAGS)
...
xspreregress: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xspreregress.o $(OBJDIR)/saLinearRegression.o $(OBJDIR)/saInsertUniqueValue.o $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(LDFLAGS)
xsprespearmancorrelate: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsprespearmancorrelate.o $(OBJDIR)/saSpearmanCorrelation.o $(OBJDIR)/saStatistics.o  $(OBJDIR)/saInsertUniqueValue.o $(OBJDIR)/saMatrixArgs.o $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o  $(OBJDIR)/saSignal.o  $(LICENSELIB) $(LDFLAGS)
xsrepredict: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsrepredict.o $(OBJDIR)/saCSV.o $(OBJDIR)/saCSV3.o $(OBJDIR)/saSignal.o  $(LICENSELIB) $(LDFLAGS)

#
# Individual C files
#
saCSV3.o:
	$(GCC) -O3 -c saCSV3.c -o $(OBJDIR)/$@
