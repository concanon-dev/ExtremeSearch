...
xsGenerateData: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ -Wall $(OBJDIR)/xsGenerateData.o $(OBJDIR)/saDice.o  $(OBJDIR)/saDoubleField.o $(OBJDIR)/saFloatField.o $(OBJDIR)/saField.o $(OBJDIR)/saIntField.o $(OBJDIR)/saOutput.o $(OBJDIR)/saProperties.o  $(OBJDIR)/saStringField.o $(OBJDIR)/saTimeField.o $(OBJDIR)/saCSV.o $(OBJDIR)/saSignal.o $(OBJDIR)/saLicensing.o $(LICENSELIB) $(WINOBJS) $(LDFLAGS)
...
xsPerformAutoRegression: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsPerformAutoRegression.o $(OBJDIR)/saAutoRegression.o $(OBJDIR)/saOpenFile.o $(OBJDIR)/saCSV.o $(OBJDIR)/saSignal.o $(OBJDIR)/saLicensing.o $(LICENSELIB) $(LDFLAGS)
xsPerformCorrelation: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsPerformCorrelation.o $(OBJDIR)/saCSV.o $(OBJDIR)/saSignal.o $(OBJDIR)/saOpenFile.o $(OBJDIR)/saLicensing.o $(LICENSELIB) $(LDFLAGS)
xsPerformLinearRegression: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsPerformLinearRegression.o $(OBJDIR)/saLinearRegression.o $(OBJDIR)/saOpenFile.o $(OBJDIR)/saCSV.o $(OBJDIR)/saSignal.o $(OBJDIR)/saLicensing.o $(LICENSELIB) $(LDFLAGS)
xsPerformQuadRegression: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsPerformQuadRegression.o $(OBJDIR)/saQuadRegression.o $(OBJDIR)/saOpenFile.o $(OBJDIR)/saCSV.o $(OBJDIR)/saSignal.o $(OBJDIR)/saLicensing.o $(LICENSELIB) $(LDFLAGS)
xsPerformSpearmanCorrelation: $(OBJECTS)
	$(GCC) -o $(BINDIR)/$@ $(CFLAGS) $(OBJDIR)/xsPerformSpearmanCorrelation.o $(OBJDIR)/saCSV.o $(OBJDIR)/saSignal.o $(OBJDIR)/saLicensing.o $(OBJDIR)/saOpenFile.o $(LICENSELIB) $(LDFLAGS)
