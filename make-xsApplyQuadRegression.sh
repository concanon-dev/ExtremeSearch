...
$gcc -o bin/$Platform/xsApplyQuadRegression -Wall -O2 -lm obj/$Platform/xsApplyQuadRegression.o obj/$Platform/saCSV.o obj/$Platform/saSignal.o obj/$Platform/saOpenFile.o obj/$Platform/saLicensing.o $LicenseLib
