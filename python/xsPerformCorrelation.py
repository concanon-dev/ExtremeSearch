...
if __name__ == '__main__':
    ...
    if yCount > 0 and yCount != xCount:
        raise Exception("xsPerformCorrelation-F-005: Unequal number of parameters"); 
    ...
    try:
        ...
        binary = os.path.dirname(sys.argv[0]) + "/"  + "/etc/apps/xtreme/bin/" +  platform.system() + "/" + platform.architecture()[0] + "/xsPerformCorrelation" 
