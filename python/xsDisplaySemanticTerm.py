...
if __name__ == '__main__':
    ...
    try:
        if len(sys.argv) >1:
            ...
            raise Exception("xsDisplaySemanticTerm-F-001: Usage: xsDisplaySemanticTerm [hedge]* term FROM context [IN scope] [; [hedge]* term FROM context [IN scope] ]* [USING synonyms]") 
        ...
        binary = platform.system() + "/" + platform.architecture()[0] + "/xsDisplaySemanticTerm"
