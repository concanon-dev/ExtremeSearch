...
if __name__ == '__main__':
    ...
    try:
        ...
        if len(sys.argv) >1:
            ...
            raise Exception("xsDisplayWhere-F-001: Usage: xsDisplayWhere [alfacut=value] field [IN context] is [modifier, ...] semanticTerm [and, or]"); 
        ...
        binary = platform.system() + "/" + platform.architecture()[0] + "/xsDisplayWhere" 
