...
$gcc -o bin/$Platform/xsApplyAutoRegression -Wall -O2 -lm obj/$Platform/xsApplyAutoRegression.o obj/$Platform/saCSV.o obj/$Platform/saSignal.o obj/$Platform/saOpenFile.o obj/$Platform/saLicensing.o $LicenseLib
