...
$gcc -o bin/$Platform/xsApplyLinearRegression -Wall -O2 -lm obj/$Platform/xsApplyLinearRegression.o obj/$Platform/saCSV.o obj/$Platform/saSignal.o obj/$Platform/saOpenFile.o obj/$Platform/saLicensing.o $LicenseLib -lm
