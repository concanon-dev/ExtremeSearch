...
$gcc -o bin/$Platform/xsLicense -Wall -O2 -lm obj/$Platform/xsLicense.o obj/$Platform/saLicenseMain.o  obj/$Platform/saCSV.o obj/$Platform/saSignal.o obj/$Platform/saLicensing.o $LicenseLib 
