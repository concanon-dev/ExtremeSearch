...
$gcc -o bin/$Platform/xsAggregateSpearmancorrelation -O2 -Wall obj/$Platform/xsAggregateSpearmanCorrelation.o obj/$Platform/saCSV.o obj/$Platform/saSignal.o obj/$Platform/saLicensing.o $LicenseLib
