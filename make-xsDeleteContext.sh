...
$gcc -o bin/$Platform/xsDeleteContext -Wall obj/$Platform/xsDeleteContext.o obj/$Platform/saSignal.o obj/$Platform/saContext.o obj/$Platform/saSplunk.o obj/$Platform/saCSV.o obj/$Platform/saLicensing.o $LicenseLib
