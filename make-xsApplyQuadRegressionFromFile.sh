...
$gcc -o bin/$Platform/xsApplyQuadRegressionFromFile -Wall -O2 -lm obj/$Platform/xsApplyQuadRegressionFromFile.o obj/$Platform/saCSV.o obj/$Platform/saSignal.o obj/$Platform/saOpenFile.o obj/$Platform/saLicensing.o $LicenseLib
