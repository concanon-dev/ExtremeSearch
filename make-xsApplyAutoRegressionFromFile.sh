...
$gcc -o bin/$Platform/xsApplyAutoRegressionFromFile -Wall -O2 -lm obj/$Platform/xsApplyAutoRegressionFromFile.o obj/$Platform/saCSV.o obj/$Platform/saSignal.o obj/$Platform/saOpenFile.o obj/$Platform/saLicensing.o $LicenseLib
