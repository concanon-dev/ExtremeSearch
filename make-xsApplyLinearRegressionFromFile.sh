...
$gcc -o bin/$Platform/xsApplyLinearRegressionFromFile -Wall -O2 -lm obj/$Platform/xsApplyLinearRegressionFromFile.o obj/$Platform/saCSV.o obj/$Platform/saSignal.o obj/$Platform/saOpenFile.o obj/$Platform/saLicensing.o $LicenseLib
