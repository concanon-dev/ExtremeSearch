...
$gcc -o bin/$Platform/xsOverlayContext -Wall obj/$Platform/xsOverlayContext.o obj/$Platform/saContext.o obj/$Platform/saSignal.o obj/$Platform/saOpenFile.o obj/$Platform/saCSV.o obj/$Platform/saLicensing.o $LicenseLib
