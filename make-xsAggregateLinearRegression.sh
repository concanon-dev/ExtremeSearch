...
$gcc -o bin/$Platform/xsAggregateLinearRegression -O2 -Wall -lm obj/$Platform/xsAggregateLinearRegression.o obj/$Platform/saLinearRegression.o obj/$Platform/csv.o obj/$Platform/saSignal.o obj/$Platform/saLicensing.o $LicenseLib
