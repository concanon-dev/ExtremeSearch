...
$gcc -o bin/$Platform/xsPerformSpearmancorrelation -O2 -Wall obj/$Platform/xsPerformSpearmanCorrelation.o obj/$Platform/csv.o obj/$Platform/saSignal.o obj/$Platform/saLicensing.o $LicenseLib
